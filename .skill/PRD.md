...
### A. Goals
*   **Decoupled & Layered Architecture**: Membangun backend berbasis REST API dengan pemisahan tanggung jawab yang jelas antar-layer (API, Service, Repository, Database, Infrastructure, Security, dan Testing).
