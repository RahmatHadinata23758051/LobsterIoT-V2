            ...
            <form onSubmit={handleBrandingSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-slate-900 text-[14px] font-bold focus:outline-none focus:border-[#0D9D1B] focus:bg-white transition"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-slate-900 text-[13px] focus:outline-none focus:border-[#0D9D1B] focus:bg-white transition"
                />
                <p className="text-[10px] text-slate-400 mt-1.5 flex items-center gap-1">
                  <Info className="h-3 w-3" />
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[13px] font-bold text-slate-900">{tempLogo || 'SLAM 2.0'}</span>
                </div>
              ...
              <button
                type="submit"
                className="w-full py-2.5 bg-[#0D9D1B] hover:bg-[#0A8516] text-white text-[12px] font-semibold rounded-lg tracking-wider uppercase transition cursor-pointer shadow-sm shadow-green-500/20"
              >
